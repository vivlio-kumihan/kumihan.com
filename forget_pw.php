  ...
  <main class="form-signin">
    ...
    <?php } else { ?>
      ...
      <form action="./forget_pw.php" method="POST">
        ...
        <button id="btn" class="w-100 btn btn-lg btn-primary " style="margin-top: 20px;" type="submit">再発行</button>
        <p class="notes"><a href="./login.php" style="text-decoration: none; color:cornflowerblue">ログイン</a>へ戻る。</p>
