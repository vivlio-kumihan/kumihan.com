...
//親テーマのstyle.cssのURL
define('PARENT_THEME_STYLE_CSS_URL', get_template_directory_uri().'/scss/style.css');
//親テーマのstyle.cssのファイルパス
define('PARENT_THEME_STYLE_CSS_FILE', get_template_directory().'/scss/style.css');
...
//子テーマのstyle.cssのURL
define('CHILD_THEME_STYLE_CSS_URL', get_stylesheet_directory_uri().'/scss/style.css');
//子テーマのstyle.cssのファイルパス
define('CHILD_THEME_STYLE_CSS_FILE', get_stylesheet_directory().'/scss/style.css');
...
define('FONT_ICOMOON_URL', get_template_directory_uri() . '/webfonts/icomoon/scss/style.css'.FONT_ICOMOON_UPDATED_VERSION_URL_QUERY);
